...
if __name__ == "__main__":
    ...
    model_path = r"D:\psh\result_inceptionnet_2_lr_e-4\best_model_inceptionnet.pth" # 최고 f1 (분류기만 학습)
    model_path = r"D:/psh/result_day_inceptionnet_alltrain_lr_e-5\best_model_inceptionnet.pth"
